...
- [git/git](https://github.com/git/git) - Git Source Code Mirror - This is a publish-only repository but pull requests can be turned into patches to the mailing list via GitGitGadget (https://gitgitgadget.github.io/). Please follow Documentat.
   - Updated on `Mon 04 November 2024 at 11:55 AM` | 52425⭐ | `Other`
...
- [Stirling-Tools/Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF) - #1 Locally hosted web application that allows you to perform various operations on PDF files.
   - Updated on `Mon 04 November 2024 at 10:14 PM` | 44773⭐ | `MIT License`
...
- [langchain-ai/langchain](https://github.com/langchain-ai/langchain) - 🦜🔗 Build context-aware reasoning applications.
   - Updated on `Mon 04 November 2024 at 11:46 PM` | 94374⭐ | `MIT License`
...
- [rust-lang/rust](https://github.com/rust-lang/rust) - Empowering everyone to build reliable and efficient software.
   - Updated on `Mon 04 November 2024 at 10:54 PM` | 98223⭐ | `Other`
...
- [jina-ai/reader](https://github.com/jina-ai/reader) - Convert any URL to an LLM-friendly input with a simple prefix https://r.jina.ai/.
   - Updated on `Fri 01 November 2024 at 06:15 AM` | 6852⭐ | `Apache License 2.0`
