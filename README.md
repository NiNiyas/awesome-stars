...
- [curl/curl](https://github.com/curl/curl) - A command line tool and library for transferring data with URL syntax, supporting DICT, FILE, FTP, FTPS, GOPHER, GOPHERS, HTTP, HTTPS, IMAP, IMAPS, LDAP, LDAPS, MQTT, MQTTS, POP3, POP3S, RTMP, RTMPS, .
   - Updated on `Mon 13 April 2026 at 11:08 PM` | 41287⭐ | `Other`
...
- [microsoft/PowerToys](https://github.com/microsoft/PowerToys) - Microsoft PowerToys is a collection of utilities that supercharge productivity and customization on Windows.
   - Updated on `Mon 13 April 2026 at 09:26 PM` | 131615⭐ | `MIT License`
...
- [godotengine/godot](https://github.com/godotengine/godot) - Godot Engine – Multi-platform 2D and 3D game engine.
   - Updated on `Mon 13 April 2026 at 09:34 PM` | 109403⭐ | `MIT License`
...
- [aetaric/checkrr](https://github.com/aetaric/checkrr) - Checkrr Scans your library files for corrupt media and optionally replaces the files via sonarr and radarr.
   - Updated on `Wed 08 April 2026 at 02:20 AM` | 518⭐ | `MIT License`
...
- [tldr-pages/tldr](https://github.com/tldr-pages/tldr) - Collaborative cheatsheets for console commands 📚.
   - Updated on `Tue 14 April 2026 at 12:20 AM` | 62106⭐ | `Other`
- [codecrafters-io/build-your-own-x](https://github.com/codecrafters-io/build-your-own-x) - Master programming by recreating your favorite technologies from scratch.
   - Updated on `Sat 21 February 2026 at 09:34 AM` | 489926⭐ | `❌`
...
- [firstcontributions/first-contributions](https://github.com/firstcontributions/first-contributions) - 🚀✨ Help beginners to contribute to open source projects.
   - Updated on `Mon 13 April 2026 at 10:19 PM` | 53463⭐ | `MIT License`
...
- [microsoft/markitdown](https://github.com/microsoft/markitdown) - Python tool for converting files and office documents to Markdown.
   - Updated on `Mon 30 March 2026 at 05:17 PM` | 106895⭐ | `MIT License`
- [MemPalace/mempalace](https://github.com/MemPalace/mempalace) - The highest-scoring AI memory system ever benchmarked. And it's free.
   - Updated on `Tue 14 April 2026 at 12:18 AM` | 44835⭐ | `MIT License`
- [JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman) - 🪨 why use many token when few token do trick — Claude Code skill that cuts 65% of tokens by talking like caveman.
   - Updated on `Sun 12 April 2026 at 05:59 PM` | 26104⭐ | `MIT License`
- [safishamsi/graphify](https://github.com/safishamsi/graphify) - AI coding assistant skill (Claude Code, Codex, OpenCode, Cursor, Gemini CLI, GitHub Copilot CLI, OpenClaw, Factory Droid, Trae, Google Antigravity). Turn any folder of code, docs, papers, images, or v.
   - Updated on `Mon 13 April 2026 at 09:49 PM` | 25131⭐ | `MIT License`
...
- [langchain-ai/deepagents](https://github.com/langchain-ai/deepagents) - Agent harness built with LangChain and LangGraph. Equipped with a planning tool, a filesystem backend, and the ability to spawn subagents - well-equipped to handle complex agentic tasks.
   - Updated on `Mon 13 April 2026 at 11:58 PM` | 20611⭐ | `MIT License`
...
- [PostHog/posthog](https://github.com/PostHog/posthog) - 🦔 PostHog is an all-in-one developer platform for building successful products. We offer product analytics, web analytics, session replay, error tracking, feature flags, experimentation, surveys, data.
   - Updated on `Tue 14 April 2026 at 12:11 AM` | 32576⭐ | `Other`
...
- [Cinnamon/kotaemon](https://github.com/Cinnamon/kotaemon) - An open-source RAG-based tool for chatting with your documents.
   - Updated on `Fri 03 April 2026 at 11:28 AM` | 25272⭐ | `Apache License 2.0`
...
- [open-webui/open-webui](https://github.com/open-webui/open-webui) - User-friendly AI Interface (Supports Ollama, OpenAI API, ...).
   - Updated on `Tue 14 April 2026 at 12:15 AM` | 131655⭐ | `Other`
...
- [openai/whisper](https://github.com/openai/whisper) - Robust Speech Recognition via Large-Scale Weak Supervision.
   - Updated on `Mon 13 April 2026 at 08:42 PM` | 97689⭐ | `MIT License`
...
- [public-apis/public-apis](https://github.com/public-apis/public-apis) - A collective list of free APIs.
   - Updated on `Wed 18 March 2026 at 04:28 PM` | 421458⭐ | `MIT License`
...
- [gitbutlerapp/gitbutler](https://github.com/gitbutlerapp/gitbutler) - The GitButler version control client, backed by Git, powered by Tauri/Rust/Svelte.
   - Updated on `Tue 14 April 2026 at 12:15 AM` | 20364⭐ | `Other`
...
- [tw93/Pake](https://github.com/tw93/Pake) - 🤱🏻 Turn any webpage into a desktop app with one command.
   - Updated on `Fri 10 April 2026 at 06:30 AM` | 47744⭐ | `MIT License`
...
- [Lazztech/Libre-Closet](https://github.com/Lazztech/Libre-Closet) - Free, open-source, self-hosted wardrobe organizer. Catalog clothes, build outfits, PWA. Docker one-liner deploy.
   - Updated on `Fri 10 April 2026 at 02:36 PM` | 121⭐ | `GNU Affero General Public License v3.0`
...
- [Stirling-Tools/Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF) - #1 PDF Application on GitHub that lets you edit PDFs on any device anywhere.
   - Updated on `Mon 13 April 2026 at 11:48 PM` | 76696⭐ | `Other`
...
- [grafana/grafana](https://github.com/grafana/grafana) - The open and composable observability and data visualization platform. Visualize metrics, logs, and traces from multiple sources like Prometheus, Loki, Elasticsearch, InfluxDB, Postgres and many more.
   - Updated on `Tue 14 April 2026 at 12:05 AM` | 73179⭐ | `GNU Affero General Public License v3.0`
...
- [oven-sh/bun](https://github.com/oven-sh/bun) - Incredibly fast JavaScript runtime, bundler, test runner, and package manager – all in one.
   - Updated on `Tue 14 April 2026 at 12:18 AM` | 89056⭐ | `Other`
