...
- [systemd/systemd](https://github.com/systemd/systemd) - The systemd System and Service Manager.
   - Updated on `Mon 13 July 2026 at 01:44 AM` | 16491⭐ | `GNU General Public License v2.0`
...
- [GloriousEggroll/proton-ge-custom](https://github.com/GloriousEggroll/proton-ge-custom) - Compatibility tool for Steam Play based on Wine and additional components.
   - Updated on `Sun 12 July 2026 at 10:47 AM` | 14662⭐ | `Other`
...
- [Diolinux/PhotoGIMP](https://github.com/Diolinux/PhotoGIMP) - A Patch for GIMP 3+ for Photoshop Users.
   - Updated on `Sat 11 July 2026 at 10:46 PM` | 15875⭐ | `GNU General Public License v3.0`
...
- [DigitalPlatDev/FreeDomain](https://github.com/DigitalPlatDev/FreeDomain) - DigitalPlat FreeDomain: Free Domain For Everyone.
   - Updated on `Fri 24 April 2026 at 01:50 PM` | 185265⭐ | `GNU Affero General Public License v3.0`
...
- [xpipe-io/xpipe](https://github.com/xpipe-io/xpipe) - Access your entire server infrastructure from your local desktop.
   - Updated on `Sun 12 July 2026 at 01:19 PM` | 14346⭐ | `Apache License 2.0`
...
- [thedotmack/claude-mem](https://github.com/thedotmack/claude-mem) - Persistent Context Across Sessions for Every Agent –  Captures everything your agent does during sessions, compresses it with AI, and injects relevant context back into future sessions. Works with Cla.
   - Updated on `Sun 12 July 2026 at 11:26 PM` | 86983⭐ | `Apache License 2.0`
...
- [JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman) - 🪨 why use many token when few token do trick — Claude Code skill that cuts 65% of tokens by talking like caveman.
   - Updated on `Fri 03 July 2026 at 11:10 AM` | 88557⭐ | `MIT License`
...
- [multica-ai/andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills) - A single CLAUDE.md file to improve Claude Code behavior, derived from Andrej Karpathy's observations on LLM coding pitfalls.
   - Updated on `Mon 20 April 2026 at 10:05 AM` | 191236⭐ | `❌`
...
- [st-tech/ppf-contact-solver](https://github.com/st-tech/ppf-contact-solver) - A contact solver for physics-based simulations involving 👚 shells, 🪵 solids, 🪢 rods, 🧱 rigid bodies and ⏳ sand.
   - Updated on `Thu 09 July 2026 at 12:11 PM` | 4269⭐ | `Apache License 2.0`
...
- [Graphify-Labs/graphify](https://github.com/Graphify-Labs/graphify) - AI coding assistant skill (Claude Code, Codex, OpenCode, Cursor, Gemini CLI, and more). Turn any folder of code, SQL schemas, R scripts, shell scripts, docs, papers, images, or videos into a queryable.
   - Updated on `Sun 12 July 2026 at 10:12 AM` | 83333⭐ | `MIT License`
...
- [D4Vinci/Scrapling](https://github.com/D4Vinci/Scrapling) - 🕷️ An adaptive Web Scraping framework that handles everything from a single request to a full-scale crawl!.
   - Updated on `Sun 12 July 2026 at 07:47 PM` | 69298⭐ | `BSD 3-Clause "New" or "Revised" License`
...
- [BerriAI/litellm](https://github.com/BerriAI/litellm) - Python SDK, Proxy Server (AI Gateway) to call 100+ LLM APIs in OpenAI (or native) format, with cost tracking, guardrails, loadbalancing and logging. [Bedrock, Azure, OpenAI, VertexAI, Cohere, Anthropi.
   - Updated on `Mon 13 July 2026 at 01:27 AM` | 53358⭐ | `Other`
...
- [hiyouga/LlamaFactory](https://github.com/hiyouga/LlamaFactory) - Unified Efficient Fine-Tuning of 100+ LLMs & VLMs (ACL 2024).
   - Updated on `Fri 10 July 2026 at 01:15 PM` | 73203⭐ | `Apache License 2.0`
...
- [open-webui/open-webui](https://github.com/open-webui/open-webui) - User-friendly AI Interface (Supports Ollama, OpenAI API, ...).
   - Updated on `Fri 10 July 2026 at 11:32 PM` | 145179⭐ | `Other`
...
- [unslothai/unsloth](https://github.com/unslothai/unsloth) - Unsloth Studio is a web UI for training and running open models like Gemma 4, Qwen3.6, DeepSeek, gpt-oss locally.
   - Updated on `Mon 13 July 2026 at 01:42 AM` | 68064⭐ | `Apache License 2.0`
...
- [langchain-ai/langchain](https://github.com/langchain-ai/langchain) - The agent engineering platform.
   - Updated on `Sun 12 July 2026 at 09:59 PM` | 141610⭐ | `MIT License`
...
- [AUTOMATIC1111/stable-diffusion-webui](https://github.com/AUTOMATIC1111/stable-diffusion-webui) - Stable Diffusion web UI.
   - Updated on `Mon 02 March 2026 at 07:00 AM` | 164198⭐ | `GNU Affero General Public License v3.0`
...
- [AzeemIdrisi/PhoneSploit-Pro](https://github.com/AzeemIdrisi/PhoneSploit-Pro) - An all-in-one hacking tool to remotely exploit Android devices using ADB and Metasploit-Framework to get a Meterpreter session.
   - Updated on `Sun 31 May 2026 at 02:05 PM` | 6017⭐ | `GNU General Public License v3.0`
...
- [vinta/awesome-python](https://github.com/vinta/awesome-python) - An opinionated list of Python frameworks, libraries, tools, and resources.
   - Updated on `Wed 08 July 2026 at 09:29 AM` | 307780⭐ | `Other`
...
- [tinyhumansai/openhuman](https://github.com/tinyhumansai/openhuman) - Your Personal AI super intelligence. A brain that builds a local-first memory of your life, a fantastic orchestrator of agent fleets and workflows, and a deep researcher.
   - Updated on `Sun 12 July 2026 at 05:30 AM` | 34738⭐ | `GNU General Public License v3.0`
...
- [oven-sh/bun](https://github.com/oven-sh/bun) - Incredibly fast JavaScript runtime, bundler, test runner, and package manager – all in one.
   - Updated on `Mon 13 July 2026 at 01:28 AM` | 94634⭐ | `Other`
...
- [astral-sh/ruff](https://github.com/astral-sh/ruff) - An extremely fast Python linter and code formatter, written in Rust.
   - Updated on `Sun 12 July 2026 at 10:46 PM` | 48545⭐ | `MIT License`
...
- [diegosouzapw/OmniRoute](https://github.com/diegosouzapw/OmniRoute) - Never stop coding. Free AI gateway: one endpoint, 231+ providers (50+ free), connect Claude Code, Codex, Cursor, Cline & Copilot to FREE Claude/GPT/Gemini. RTK+Caveman stacked compression saves 15-95%.
   - Updated on `Mon 13 July 2026 at 01:41 AM` | 16246⭐ | `MIT License`
...
- [colbymchenry/codegraph](https://github.com/colbymchenry/codegraph) - Pre-indexed code knowledge graph, auto syncs on code changes, for Claude Code, Codex, Gemini, Cursor, OpenCode, AntiGravity, Kiro, and Hermes Agent — fewer tokens, fewer tool calls, 100% local.
   - Updated on `Mon 13 July 2026 at 01:09 AM` | 59440⭐ | `MIT License`
...
- [millionco/react-doctor](https://github.com/millionco/react-doctor) - Your agent writes bad React. This catches it.
   - Updated on `Mon 13 July 2026 at 01:40 AM` | 13551⭐ | `Other`
...
- [mauriceboe/TREK](https://github.com/mauriceboe/TREK) - A self-hosted travel/trip planner with real-time collaboration, interactive maps, PWA support, SSO, budgets, packing lists, and more.
   - Updated on `Sun 12 July 2026 at 11:18 PM` | 10189⭐ | `GNU Affero General Public License v3.0`
...
- [Crosstalk-Solutions/project-nomad](https://github.com/Crosstalk-Solutions/project-nomad) - Project N.O.M.A.D, is a self-contained, offline survival computer packed with critical tools, knowledge, and AI to keep you informed and empowered—anytime, anywhere.
   - Updated on `Sun 12 July 2026 at 09:46 PM` | 33818⭐ | `Apache License 2.0`
...
- [linshenkx/prompt-optimizer](https://github.com/linshenkx/prompt-optimizer) - An AI prompt optimizer for writing better prompts and getting better AI results.
   - Updated on `Mon 06 July 2026 at 01:54 AM` | 32034⭐ | `Other`
...
- [gitroomhq/postiz-app](https://github.com/gitroomhq/postiz-app) - 📨 The ultimate agentic social media scheduling tool 🤖.
   - Updated on `Fri 10 July 2026 at 03:27 AM` | 33145⭐ | `GNU Affero General Public License v3.0`
...
- [upscayl/upscayl](https://github.com/upscayl/upscayl) - 🆙 Upscayl - #1 Free and Open Source AI Image Upscaler for Linux, MacOS and Windows.
   - Updated on `Sat 11 July 2026 at 05:13 AM` | 46906⭐ | `GNU Affero General Public License v3.0`
