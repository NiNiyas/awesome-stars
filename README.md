...
- [ggml-org/llama.cpp](https://github.com/ggml-org/llama.cpp) - LLM inference in C/C++.
   - Updated on `Mon 11 May 2026 at 11:54 PM` | 109593⭐ | `MIT License`
...
- [k4yt3x/video2x](https://github.com/k4yt3x/video2x) - A machine learning-based video super resolution and frame interpolation framework. Est. Hack the Valley II, 2018.
   - Updated on `Sat 07 March 2026 at 03:39 PM` | 19852⭐ | `GNU Affero General Public License v3.0`
...
- [iv-org/invidious](https://github.com/iv-org/invidious) - Invidious is an alternative front-end to YouTube.
   - Updated on `Tue 05 May 2026 at 01:31 PM` | 19836⭐ | `GNU Affero General Public License v3.0`
...
- [garethgeorge/backrest](https://github.com/garethgeorge/backrest) - Backrest is a web UI and orchestrator for restic backup.
   - Updated on `Mon 11 May 2026 at 04:57 AM` | 6257⭐ | `GNU General Public License v3.0`
...
- [nektos/act](https://github.com/nektos/act) - Run your GitHub Actions locally 🚀.
   - Updated on `Mon 11 May 2026 at 04:10 PM` | 70247⭐ | `MIT License`
...
- [gotify/server](https://github.com/gotify/server) - A simple server for sending and receiving messages in real-time per WebSocket. (Includes a sleek web-ui).
   - Updated on `Sun 10 May 2026 at 01:43 PM` | 14980⭐ | `Other`
...
- [authelia/authelia](https://github.com/authelia/authelia) - The Single Sign-On Multi-Factor portal for web apps, now OpenID Certified™.
   - Updated on `Mon 11 May 2026 at 11:46 PM` | 27749⭐ | `Apache License 2.0`
...
- [opendataloader-project/opendataloader-pdf](https://github.com/opendataloader-project/opendataloader-pdf) - PDF Parser for AI-ready data. Automate PDF accessibility. Open-source.
   - Updated on `Mon 11 May 2026 at 03:14 PM` | 21107⭐ | `Apache License 2.0`
...
- [decolua/9router](https://github.com/decolua/9router) - Unlimited FREE AI coding. Connect Claude Code, Codex, Cursor, Cline, Copilot, Antigravity to FREE Claude/GPT/Gemini via 40+ providers. Auto-fallback, RTK -40% tokens, never hit limits.
   - Updated on `Mon 11 May 2026 at 04:51 PM` | 8297⭐ | `MIT License`
- [JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman) - 🪨 why use many token when few token do trick — Claude Code skill that cuts 65% of tokens by talking like caveman.
   - Updated on `Sun 10 May 2026 at 02:05 PM` | 58297⭐ | `MIT License`
...
- [advplyr/audiobookshelf](https://github.com/advplyr/audiobookshelf) - Self-hosted audiobook and podcast server.
   - Updated on `Tue 05 May 2026 at 10:18 PM` | 12731⭐ | `GNU General Public License v3.0`
...
- [vercel/next.js](https://github.com/vercel/next.js) - The React Framework.
   - Updated on `Tue 12 May 2026 at 12:10 AM` | 139395⭐ | `MIT License`
...
- [JunkFood02/Seal](https://github.com/JunkFood02/Seal) - 🦭 Video/Audio Downloader for Android, based on yt-dlp.
   - Updated on `Sat 25 April 2026 at 03:44 PM` | 26175⭐ | `GNU General Public License v3.0`
...
- [ai-boost/awesome-prompts](https://github.com/ai-boost/awesome-prompts) - Curated list of chatgpt prompts from the top-rated GPTs in the GPTs Store. Prompt Engineering, prompt attack & prompt protect. Advanced Prompt Engineering papers.
   - Updated on `Mon 11 May 2026 at 09:09 PM` | 7858⭐ | `GNU General Public License v3.0`
...
- [sindresorhus/awesome](https://github.com/sindresorhus/awesome) - 😎 Awesome lists about all kinds of interesting topics.
   - Updated on `Tue 05 May 2026 at 02:47 PM` | 465341⭐ | `Creative Commons Zero v1.0 Universal`
...
- [microsoft/markitdown](https://github.com/microsoft/markitdown) - Python tool for converting files and office documents to Markdown.
   - Updated on `Mon 20 April 2026 at 05:52 PM` | 122661⭐ | `MIT License`
...
- [safishamsi/graphify](https://github.com/safishamsi/graphify) - AI coding assistant skill (Claude Code, Codex, OpenCode, Cursor, Gemini CLI, and more). Turn any folder of code, SQL schemas, R scripts, shell scripts, docs, papers, images, or videos into a queryable.
   - Updated on `Mon 11 May 2026 at 08:20 PM` | 46697⭐ | `MIT License`
...
- [langchain-ai/deepagents](https://github.com/langchain-ai/deepagents) - Agent harness built with LangChain and LangGraph.
   - Updated on `Mon 11 May 2026 at 10:04 PM` | 22650⭐ | `MIT License`
...
- [BerriAI/litellm](https://github.com/BerriAI/litellm) - Python SDK, Proxy Server (AI Gateway) to call 100+ LLM APIs in OpenAI (or native) format, with cost tracking, guardrails, loadbalancing and logging. [Bedrock, Azure, OpenAI, VertexAI, Cohere, Anthropi.
   - Updated on `Tue 12 May 2026 at 12:23 AM` | 46572⭐ | `Other`
...
- [MustardChef/WSABuilds](https://github.com/MustardChef/WSABuilds) - Run Windows Subsystem For Android on your Windows 10 and Windows 11 PC using prebuilt binaries with Google Play Store (MindTheGapps) and/or Magisk or KernelSU (root solutions) built in.
   - Updated on `Mon 20 April 2026 at 05:54 PM` | 17177⭐ | `GNU Affero General Public License v3.0`
...
- [yt-dlp/yt-dlp](https://github.com/yt-dlp/yt-dlp) - A feature-rich command-line audio/video downloader.
   - Updated on `Tue 05 May 2026 at 10:54 PM` | 161762⭐ | `The Unlicense`
...
- [denoland/deno](https://github.com/denoland/deno) - A modern runtime for JavaScript and TypeScript.
   - Updated on `Mon 11 May 2026 at 11:54 PM` | 106643⭐ | `MIT License`
...
- [anomalyco/opencode](https://github.com/anomalyco/opencode) - The open source coding agent.
   - Updated on `Tue 12 May 2026 at 12:24 AM` | 158586⭐ | `MIT License`
...
- [spotbye/SpotiFLAC](https://github.com/spotbye/SpotiFLAC) - Get Spotify tracks in true FLAC from Tidal, Qobuz & Amazon Music — no account required.
   - Updated on `Sun 26 April 2026 at 12:34 AM` | 8309⭐ | `MIT License`
...
- [cline/cline](https://github.com/cline/cline) - Autonomous coding agent right in your IDE, capable of creating/editing files, executing commands, using the browser, and more with your permission every step of the way.
   - Updated on `Tue 12 May 2026 at 12:16 AM` | 61635⭐ | `Apache License 2.0`
...
- [remix-run/remix](https://github.com/remix-run/remix) - Build Better Websites. Create modern, resilient user experiences with web fundamentals.
   - Updated on `Tue 12 May 2026 at 12:20 AM` | 32915⭐ | `MIT License`
...
- [Expensify/App](https://github.com/Expensify/App) - Welcome to New Expensify: a complete re-imagination of financial collaboration, centered around chat. Help us build the next generation of Expensify by sharing feedback and contributing to the code.
   - Updated on `Tue 12 May 2026 at 12:23 AM` | 4849⭐ | `MIT License`
...
- [renovatebot/renovate](https://github.com/renovatebot/renovate) - Home of the Renovate CLI: Cross-platform Dependency Automation by Mend.io.
   - Updated on `Tue 12 May 2026 at 12:23 AM` | 21490⭐ | `GNU Affero General Public License v3.0`
...
- [supabase/supabase](https://github.com/supabase/supabase) - The Postgres development platform. Supabase gives you a dedicated Postgres database to build your web, mobile, and AI applications.
   - Updated on `Mon 11 May 2026 at 11:28 PM` | 102188⭐ | `Apache License 2.0`
