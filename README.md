...
- [curl/curl](https://github.com/curl/curl) - A command line tool and library for transferring data with URL syntax, supporting DICT, FILE, FTP, FTPS, GOPHER, GOPHERS, HTTP, HTTPS, IMAP, IMAPS, LDAP, LDAPS, MQTT, MQTTS, POP3, POP3S, RTSP, SCP, SF.
   - Updated on `Tue 02 June 2026 at 10:28 PM` | 42046⭐ | `Other`
...
- [vpnhood/VpnHood](https://github.com/vpnhood/VpnHood) - Undetectable, Fast,  Cross-Platform, Free VPN.
   - Updated on `Tue 02 June 2026 at 06:36 PM` | 2193⭐ | `GNU Lesser General Public License v2.1`
...
- [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) - An Open Source Machine Learning Framework for Everyone.
   - Updated on `Wed 03 June 2026 at 12:39 AM` | 195392⭐ | `Apache License 2.0`
...
- [ollama/ollama](https://github.com/ollama/ollama) - Get up and running with Kimi-K2.5, GLM-5, MiniMax, DeepSeek, gpt-oss, Qwen, Gemma and other models.
   - Updated on `Tue 02 June 2026 at 11:36 PM` | 172961⭐ | `MIT License`
...
- [syncthing/syncthing](https://github.com/syncthing/syncthing) - Open Source Continuous File Synchronization.
   - Updated on `Tue 02 June 2026 at 03:12 PM` | 84910⭐ | `Mozilla Public License 2.0`
...
- [opendataloader-project/opendataloader-pdf](https://github.com/opendataloader-project/opendataloader-pdf) - PDF Parser for AI-ready data. Automate PDF accessibility. Open-source.
   - Updated on `Tue 02 June 2026 at 04:10 PM` | 22752⭐ | `Apache License 2.0`
...
- [folke/trouble.nvim](https://github.com/folke/trouble.nvim) - 🚦 A pretty diagnostics, references, telescope results, quickfix and location list to help you solve all the trouble your code is causing.
   - Updated on `Fri 31 October 2025 at 02:02 PM` | 6807⭐ | `Apache License 2.0`
...
- [multica-ai/andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills) - A single CLAUDE.md file to improve Claude Code behavior, derived from Andrej Karpathy's observations on LLM coding pitfalls.
   - Updated on `Mon 20 April 2026 at 10:05 AM` | 165867⭐ | `❌`
...
- [microsoft/markitdown](https://github.com/microsoft/markitdown) - Python tool for converting files and office documents to Markdown.
   - Updated on `Tue 26 May 2026 at 10:41 PM` | 141113⭐ | `MIT License`
...
- [safishamsi/graphify](https://github.com/safishamsi/graphify) - AI coding assistant skill (Claude Code, Codex, OpenCode, Cursor, Gemini CLI, and more). Turn any folder of code, SQL schemas, R scripts, shell scripts, docs, papers, images, or videos into a queryable.
   - Updated on `Tue 02 June 2026 at 11:26 PM` | 58414⭐ | `MIT License`
...
- [D4Vinci/Scrapling](https://github.com/D4Vinci/Scrapling) - 🕷️ An adaptive Web Scraping framework that handles everything from a single request to a full-scale crawl!.
   - Updated on `Mon 01 June 2026 at 11:19 PM` | 59153⭐ | `BSD 3-Clause "New" or "Revised" License`
...
- [modelcontextprotocol/python-sdk](https://github.com/modelcontextprotocol/python-sdk) - The official Python SDK for Model Context Protocol servers and clients.
   - Updated on `Tue 02 June 2026 at 11:44 PM` | 23205⭐ | `MIT License`
...
- [browser-use/browser-use](https://github.com/browser-use/browser-use) - 🌐 Make websites accessible for AI agents. Automate tasks online with ease.
   - Updated on `Mon 01 June 2026 at 06:49 PM` | 96788⭐ | `MIT License`
...
- [rommapp/romm](https://github.com/rommapp/romm) - A beautiful, powerful, self-hosted rom manager and player.
   - Updated on `Tue 02 June 2026 at 06:40 PM` | 8945⭐ | `GNU Affero General Public License v3.0`
- [docling-project/docling](https://github.com/docling-project/docling) - Get your documents ready for gen AI.
   - Updated on `Tue 02 June 2026 at 03:59 PM` | 60862⭐ | `MIT License`
...
- [BerriAI/litellm](https://github.com/BerriAI/litellm) - Python SDK, Proxy Server (AI Gateway) to call 100+ LLM APIs in OpenAI (or native) format, with cost tracking, guardrails, loadbalancing and logging. [Bedrock, Azure, OpenAI, VertexAI, Cohere, Anthropi.
   - Updated on `Wed 03 June 2026 at 12:31 AM` | 49071⭐ | `Other`
...
- [mem0ai/mem0](https://github.com/mem0ai/mem0) - Universal memory layer for AI Agents.
   - Updated on `Tue 02 June 2026 at 07:25 PM` | 57444⭐ | `Apache License 2.0`
...
- [OpenHands/OpenHands](https://github.com/OpenHands/OpenHands) - 🙌 OpenHands: AI-Driven Development.
   - Updated on `Tue 02 June 2026 at 11:31 PM` | 75682⭐ | `Other`
...
- [sherlock-project/sherlock](https://github.com/sherlock-project/sherlock) - Hunt down social media accounts by username across social networks.
   - Updated on `Tue 02 June 2026 at 06:35 AM` | 84405⭐ | `MIT License`
...
- [open-webui/open-webui](https://github.com/open-webui/open-webui) - User-friendly AI Interface (Supports Ollama, OpenAI API, ...).
   - Updated on `Tue 02 June 2026 at 02:22 AM` | 139736⭐ | `Other`
...
- [warpdotdev/warp](https://github.com/warpdotdev/warp) - Warp is an agentic development environment, born out of the terminal.
   - Updated on `Wed 03 June 2026 at 12:31 AM` | 60885⭐ | `GNU Affero General Public License v3.0`
...
- [helix-editor/helix](https://github.com/helix-editor/helix) - A post-modern modal text editor.
   - Updated on `Mon 01 June 2026 at 01:31 PM` | 44613⭐ | `Mozilla Public License 2.0`
...
- [dani-garcia/vaultwarden](https://github.com/dani-garcia/vaultwarden) - Unofficial Bitwarden compatible server written in Rust, formerly known as bitwarden_rs.
   - Updated on `Sun 17 May 2026 at 07:46 PM` | 61753⭐ | `GNU Affero General Public License v3.0`
...
- [thedotmack/claude-mem](https://github.com/thedotmack/claude-mem) - Persistent Context Across Sessions for Every Agent –  Captures everything your agent does during sessions, compresses it with AI, and injects relevant context back into future sessions. Works with Cla.
   - Updated on `Fri 29 May 2026 at 07:19 PM` | 80269⭐ | `Apache License 2.0`
...
- [colbymchenry/codegraph](https://github.com/colbymchenry/codegraph) - Pre-indexed code knowledge graph for Claude Code, Codex, Gemini, Cursor, OpenCode, AntiGravity, Kiro, and Hermes Agent — fewer tokens, fewer tool calls, 100% local.
   - Updated on `Tue 02 June 2026 at 10:50 PM` | 37942⭐ | `MIT License`
...
- [millionco/react-doctor](https://github.com/millionco/react-doctor) - Your agent writes bad React. This catches it.
   - Updated on `Wed 03 June 2026 at 12:24 AM` | 11967⭐ | `MIT License`
- [playcanvas/supersplat](https://github.com/playcanvas/supersplat) - 3D Gaussian Splat Editor.
   - Updated on `Wed 27 May 2026 at 12:31 PM` | 8949⭐ | `MIT License`
...
- [anomalyco/opencode](https://github.com/anomalyco/opencode) - The open source coding agent.
   - Updated on `Wed 03 June 2026 at 12:05 AM` | 168926⭐ | `MIT License`
...
- [puckeditor/puck](https://github.com/puckeditor/puck) - The visual editor for React.
   - Updated on `Tue 02 June 2026 at 02:20 PM` | 12760⭐ | `MIT License`
- [C4illin/ConvertX](https://github.com/C4illin/ConvertX) - 💾 Self-hosted online file converter. Supports 1000+ formats ⚙️.
   - Updated on `Mon 27 April 2026 at 07:43 PM` | 16951⭐ | `GNU Affero General Public License v3.0`
...
- [remix-run/remix](https://github.com/remix-run/remix) - Build Better Websites. Create modern, resilient user experiences with web fundamentals.
   - Updated on `Wed 03 June 2026 at 12:39 AM` | 33010⭐ | `MIT License`
...
- [firecrawl/firecrawl](https://github.com/firecrawl/firecrawl) - The API to search, scrape, and interact with the web at scale. 🔥.
   - Updated on `Wed 03 June 2026 at 12:36 AM` | 127741⭐ | `GNU Affero General Public License v3.0`
- [jina-ai/reader](https://github.com/jina-ai/reader) - Convert any URL to an LLM-friendly input with a simple prefix https://r.jina.ai/.
   - Updated on `Fri 22 May 2026 at 02:56 AM` | 10995⭐ | `Apache License 2.0`
...
- [grafana/grafana](https://github.com/grafana/grafana) - The open and composable observability and data visualization platform. Visualize metrics, logs, and traces from multiple sources like Prometheus, Loki, Elasticsearch, InfluxDB, Postgres and many more.
   - Updated on `Tue 02 June 2026 at 11:55 PM` | 74118⭐ | `GNU Affero General Public License v3.0`
...
- [vbenjs/vue-vben-admin](https://github.com/vbenjs/vue-vben-admin) - A modern vue admin panel built with Vue3, Shadcn UI, Vite, TypeScript, and Monorepo. It's fast!.
   - Updated on `Sun 31 May 2026 at 07:42 AM` | 32525⭐ | `MIT License`
