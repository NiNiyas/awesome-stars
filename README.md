...
- [massgravel/Microsoft-Activation-Scripts](https://github.com/massgravel/Microsoft-Activation-Scripts) - Open-source Windows and Office activator featuring HWID, Ohook, TSforge, and Online KMS activation methods, along with advanced troubleshooting.
   - Updated on `Sat 04 July 2026 at 04:54 PM` | 183486⭐ | `GNU General Public License v3.0`
...
- [iOfficeAI/OfficeCLI](https://github.com/iOfficeAI/OfficeCLI) - OfficeCLI is the first and best Office suite  purpose-built for AI agents to read, edit, and automate Word, Excel, and PowerPoint files. Free, open-source, single binary, no Office installation requir.
   - Updated on `Fri 17 July 2026 at 08:13 PM` | 18832⭐ | `Apache License 2.0`
...
- [BasedHardware/omi](https://github.com/BasedHardware/omi) - AI that sees your screen, listens to your conversations and tells you what to do.
   - Updated on `Sat 18 July 2026 at 01:09 AM` | 13025⭐ | `MIT License`
...
- [JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman) - 🪨 why use many token when few token do trick — Claude Code skill that cuts 65% of tokens by talking like caveman.
   - Updated on `Fri 03 July 2026 at 11:10 AM` | 90349⭐ | `MIT License`
...
- [codecrafters-io/build-your-own-x](https://github.com/codecrafters-io/build-your-own-x) - Master programming by recreating your favorite technologies from scratch.
   - Updated on `Tue 14 July 2026 at 07:25 PM` | 527384⭐ | `❌`
...
- [DigitalPlatDev/FreeDomain](https://github.com/DigitalPlatDev/FreeDomain) - DigitalPlat FreeDomain: Free Domain For Everyone.
   - Updated on `Thu 16 July 2026 at 03:38 PM` | 186497⭐ | `GNU Affero General Public License v3.0`
...
- [zoicware/RemoveWindowsAI](https://github.com/zoicware/RemoveWindowsAI) - Force Remove Copilot, Recall and More in Windows 11.
   - Updated on `Mon 13 July 2026 at 04:25 PM` | 12414⭐ | `MIT License`
...
- [odysseus-dev/odysseus](https://github.com/odysseus-dev/odysseus) - Self-hosted AI workspace.
   - Updated on `Thu 16 July 2026 at 05:36 PM` | 83125⭐ | `GNU Affero General Public License v3.0`
...
- [cocoindex-io/cocoindex-code](https://github.com/cocoindex-io/cocoindex-code) - A super light-weight embedded code search engine CLI (AST based) that just works -  improves speed and efficiency for coding agent  🌟 Star if you like it!.
   - Updated on `Sat 18 July 2026 at 01:27 AM` | 2518⭐ | `Apache License 2.0`
...
- [Graphify-Labs/graphify](https://github.com/Graphify-Labs/graphify) - AI coding assistant skill (Claude Code, Codex, OpenCode, Cursor, Gemini CLI, and more). Turn any folder of code, SQL schemas, R scripts, shell scripts, docs, papers, images, or videos into a queryable.
   - Updated on `Fri 17 July 2026 at 01:57 PM` | 90265⭐ | `MIT License`
...
- [XiaoYouChR/Ghost-Downloader-3](https://github.com/XiaoYouChR/Ghost-Downloader-3) - An AI-boost cross-platform multi-protocol fluent-design concurrent downloader built with Python & Qt.
   - Updated on `Wed 15 July 2026 at 05:24 PM` | 6477⭐ | `GNU General Public License v3.0`
...
- [open-webui/open-webui](https://github.com/open-webui/open-webui) - User-friendly AI Interface (Supports Ollama, OpenAI API, ...).
   - Updated on `Fri 17 July 2026 at 11:32 PM` | 145789⭐ | `Other`
...
- [oven-sh/bun](https://github.com/oven-sh/bun) - Incredibly fast JavaScript runtime, bundler, test runner, and package manager – all in one.
   - Updated on `Sat 18 July 2026 at 01:27 AM` | 94803⭐ | `Other`
...
- [openinterpreter/openinterpreter](https://github.com/openinterpreter/openinterpreter) - A coding agent for open models like Kimi K3.
   - Updated on `Sat 18 July 2026 at 01:14 AM` | 66377⭐ | `Apache License 2.0`
...
- [can1357/oh-my-pi](https://github.com/can1357/oh-my-pi) - ⌥  AI Coding agent for the terminal — hash-anchored edits, optimized tool harness, LSP, Python, browser, subagents, and more.
   - Updated on `Sat 18 July 2026 at 12:53 AM` | 18238⭐ | `MIT License`
...
- [diegosouzapw/OmniRoute](https://github.com/diegosouzapw/OmniRoute) - Never stop coding. Free AI gateway: one endpoint, 231+ providers (50+ free), connect Claude Code, Codex, Cursor, Cline & Copilot to FREE Claude/GPT/Gemini. RTK+Caveman stacked compression saves 15-95%.
   - Updated on `Sat 18 July 2026 at 01:09 AM` | 18389⭐ | `MIT License`
...
- [colbymchenry/codegraph](https://github.com/colbymchenry/codegraph) - Pre-indexed code knowledge graph, auto syncs on code changes, for Claude Code, Codex, Gemini, Cursor, OpenCode, AntiGravity, Kiro, and Hermes Agent — fewer tokens, fewer tool calls, 100% local.
   - Updated on `Fri 17 July 2026 at 09:56 PM` | 60643⭐ | `MIT License`
...
- [Infisical/infisical](https://github.com/Infisical/infisical) - Infisical is the open-source platform for secrets, certificates, and privileged access management.
   - Updated on `Sat 18 July 2026 at 12:44 AM` | 28163⭐ | `Other`
