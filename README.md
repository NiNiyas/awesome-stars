...
- [Jackett/Jackett](https://github.com/Jackett/Jackett) - API Support for your favorite torrent trackers.
   - Updated on `Wed 08 July 2026 at 01:46 AM` | 15689⭐ | `GNU General Public License v2.0`
...
- [windirstat/windirstat](https://github.com/windirstat/windirstat) - WinDirStat is a disk usage statistics viewer and cleanup tool for Microsoft Windows.
   - Updated on `Tue 07 July 2026 at 11:20 PM` | 3602⭐ | `GNU General Public License v2.0`
...
- [ggml-org/llama.cpp](https://github.com/ggml-org/llama.cpp) - LLM inference in C/C++.
   - Updated on `Wed 08 July 2026 at 12:23 AM` | 119604⭐ | `MIT License`
...
- [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) - An Open Source Machine Learning Framework for Everyone.
   - Updated on `Wed 08 July 2026 at 01:45 AM` | 196108⭐ | `Apache License 2.0`
...
- [Diolinux/PhotoGIMP](https://github.com/Diolinux/PhotoGIMP) - A Patch for GIMP 3+ for Photoshop Users.
   - Updated on `Wed 01 July 2026 at 05:39 PM` | 14270⭐ | `GNU General Public License v3.0`
...
- [BasedHardware/omi](https://github.com/BasedHardware/omi) - AI that sees your screen, listens to your conversations and tells you what to do.
   - Updated on `Wed 08 July 2026 at 01:47 AM` | 12954⭐ | `MIT License`
...
- [DigitalPlatDev/FreeDomain](https://github.com/DigitalPlatDev/FreeDomain) - DigitalPlat FreeDomain: Free Domain For Everyone.
   - Updated on `Fri 24 April 2026 at 01:50 PM` | 183748⭐ | `GNU Affero General Public License v3.0`
...
- [ripienaar/free-for-dev](https://github.com/ripienaar/free-for-dev) - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev.
   - Updated on `Tue 07 July 2026 at 05:17 PM` | 128730⭐ | `❌`
...
- [thedotmack/claude-mem](https://github.com/thedotmack/claude-mem) - Persistent Context Across Sessions for Every Agent –  Captures everything your agent does during sessions, compresses it with AI, and injects relevant context back into future sessions. Works with Cla.
   - Updated on `Mon 06 July 2026 at 07:34 PM` | 86337⭐ | `Apache License 2.0`
...
- [JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman) - 🪨 why use many token when few token do trick — Claude Code skill that cuts 65% of tokens by talking like caveman.
   - Updated on `Fri 03 July 2026 at 11:10 AM` | 86284⭐ | `MIT License`
...
- [gethomepage/homepage](https://github.com/gethomepage/homepage) - A highly customizable homepage (or startpage / application dashboard) with Docker and service API integrations.
   - Updated on `Wed 08 July 2026 at 01:44 AM` | 31393⭐ | `GNU General Public License v3.0`
...
- [louislam/uptime-kuma](https://github.com/louislam/uptime-kuma) - A fancy self-hosted monitoring tool.
   - Updated on `Wed 08 July 2026 at 12:20 AM` | 88865⭐ | `MIT License`
...
- [multica-ai/andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills) - A single CLAUDE.md file to improve Claude Code behavior, derived from Andrej Karpathy's observations on LLM coding pitfalls.
   - Updated on `Mon 20 April 2026 at 10:05 AM` | 189092⭐ | `❌`
...
- [ChrisTitusTech/winutil](https://github.com/ChrisTitusTech/winutil) - Chris Titus Tech's Windows Utility - Install Programs, Tweaks, Fixes, and Updates.
   - Updated on `Tue 07 July 2026 at 04:15 PM` | 57306⭐ | `MIT License`
...
- [pewdiepie-archdaemon/odysseus](https://github.com/pewdiepie-archdaemon/odysseus) - Self-hosted AI workspace.
   - Updated on `Tue 07 July 2026 at 02:32 AM` | 81470⭐ | `GNU Affero General Public License v3.0`
...
- [Graphify-Labs/graphify](https://github.com/Graphify-Labs/graphify) - AI coding assistant skill (Claude Code, Codex, OpenCode, Cursor, Gemini CLI, and more). Turn any folder of code, SQL schemas, R scripts, shell scripts, docs, papers, images, or videos into a queryable.
   - Updated on `Wed 08 July 2026 at 12:28 AM` | 79600⭐ | `MIT License`
...
- [PostHog/posthog](https://github.com/PostHog/posthog) - 🦔 PostHog is an all-in-one developer platform for building successful products. We offer product analytics, web analytics, session replay, error tracking, feature flags, experimentation, surveys, data.
   - Updated on `Wed 08 July 2026 at 01:43 AM` | 35368⭐ | `Other`
...
- [google/langextract](https://github.com/google/langextract) - A Python library for extracting structured information from unstructured text using LLMs with precise source grounding and interactive visualization.
   - Updated on `Thu 02 July 2026 at 07:59 AM` | 37065⭐ | `Apache License 2.0`
...
- [browser-use/browser-use](https://github.com/browser-use/browser-use) - 🌐 Make websites accessible for AI agents. Automate tasks online with ease.
   - Updated on `Wed 08 July 2026 at 12:18 AM` | 103348⭐ | `MIT License`
...
- [cheahjs/free-llm-api-resources](https://github.com/cheahjs/free-llm-api-resources) - A list of free LLM inference resources accessible via API.
   - Updated on `Tue 07 July 2026 at 12:44 AM` | 26211⭐ | `❌`
...
- [BerriAI/litellm](https://github.com/BerriAI/litellm) - Python SDK, Proxy Server (AI Gateway) to call 100+ LLM APIs in OpenAI (or native) format, with cost tracking, guardrails, loadbalancing and logging. [Bedrock, Azure, OpenAI, VertexAI, Cohere, Anthropi.
   - Updated on `Wed 08 July 2026 at 01:38 AM` | 52900⭐ | `Other`
...
- [fastapi/fastapi](https://github.com/fastapi/fastapi) - FastAPI framework, high performance, easy to learn, fast to code, ready for production.
   - Updated on `Tue 07 July 2026 at 07:03 PM` | 100208⭐ | `MIT License`
...
- [goauthentik/authentik](https://github.com/goauthentik/authentik) - The authentication glue you need.
   - Updated on `Wed 08 July 2026 at 01:17 AM` | 22246⭐ | `Other`
...
- [oven-sh/bun](https://github.com/oven-sh/bun) - Incredibly fast JavaScript runtime, bundler, test runner, and package manager – all in one.
   - Updated on `Wed 08 July 2026 at 01:45 AM` | 93634⭐ | `Other`
...
- [nvm-sh/nvm](https://github.com/nvm-sh/nvm) - Node Version Manager - POSIX-compliant bash script to manage multiple active node.js versions.
   - Updated on `Mon 06 July 2026 at 06:25 PM` | 94056⭐ | `MIT License`
...
- [VSCodium/vscodium](https://github.com/VSCodium/vscodium) - binary releases of VS Code without MS branding/telemetry/licensing.
   - Updated on `Tue 07 July 2026 at 01:01 PM` | 32243⭐ | `MIT License`
...
- [anomalyco/opencode](https://github.com/anomalyco/opencode) - The open source coding agent.
   - Updated on `Wed 08 July 2026 at 01:32 AM` | 183385⭐ | `MIT License`
...
- [hydralauncher/hydra](https://github.com/hydralauncher/hydra) - Hydra Launcher is an open-source gaming platform created to be the single tool that you need.
   - Updated on `Wed 08 July 2026 at 01:31 AM` | 16340⭐ | `MIT License`
...
- [kubero-dev/kubero](https://github.com/kubero-dev/kubero) - A free and self-hosted PaaS alternative to Heroku / Netlify / Coolify / Vercel / Dokku / Portainer running on Kubernetes.
   - Updated on `Wed 24 June 2026 at 12:08 PM` | 4342⭐ | `GNU General Public License v3.0`
...
- [laurent22/joplin](https://github.com/laurent22/joplin) - Joplin - the privacy-focused note taking app with sync capabilities for Windows, macOS, Linux, Android and iOS.
   - Updated on `Tue 07 July 2026 at 07:59 AM` | 55475⭐ | `Other`
...
- [iptv-org/iptv](https://github.com/iptv-org/iptv) - Collection of publicly available IPTV channels from all over the world.
   - Updated on `Wed 08 July 2026 at 12:27 AM` | 131020⭐ | `The Unlicense`
