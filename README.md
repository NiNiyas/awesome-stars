...
- [videolan/vlc](https://github.com/videolan/vlc) - VLC media player - plays everything, runs anywhere. Code here: https://code.videolan.org/videolan/vlc.
   - Updated on `Sun 28 June 2026 at 08:58 PM` | 18832⭐ | `GNU General Public License v2.0`
...
- [ggml-org/whisper.cpp](https://github.com/ggml-org/whisper.cpp) - Port of OpenAI's Whisper model in C/C++.
   - Updated on `Fri 26 June 2026 at 01:04 PM` | 51114⭐ | `MIT License`
...
- [godotengine/godot](https://github.com/godotengine/godot) - Godot Engine – Multi-platform 2D and 3D game engine.
   - Updated on `Sun 28 June 2026 at 11:35 AM` | 113261⭐ | `MIT License`
...
- [penpot/penpot](https://github.com/penpot/penpot) - Penpot: The open-source design tool for design and code collaboration.
   - Updated on `Fri 26 June 2026 at 10:01 PM` | 54391⭐ | `Mozilla Public License 2.0`
...
- [edde746/plezy](https://github.com/edde746/plezy) - Modern cross-platform Plex & Jellyfin client built with Flutter.
   - Updated on `Sun 28 June 2026 at 07:49 PM` | 2744⭐ | `GNU General Public License v3.0`
...
- [coreybutler/nvm-windows](https://github.com/coreybutler/nvm-windows) - A node.js version management utility for Windows. Ironically written in Go.
   - Updated on `Fri 17 April 2026 at 05:58 PM` | 46924⭐ | `MIT License`
...
- [ripienaar/free-for-dev](https://github.com/ripienaar/free-for-dev) - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev.
   - Updated on `Sun 28 June 2026 at 07:23 PM` | 125203⭐ | `❌`
...
- [NextAlone/Nagram](https://github.com/NextAlone/Nagram) - The third-party Telegram android app.
   - Updated on `Sun 28 June 2026 at 03:20 PM` | 2940⭐ | `GNU General Public License v3.0`
- [xpipe-io/xpipe](https://github.com/xpipe-io/xpipe) - Access your entire server infrastructure from your local desktop.
   - Updated on `Sun 28 June 2026 at 02:58 PM` | 14215⭐ | `Apache License 2.0`
- [Stirling-Tools/Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF) - #1 PDF Application on GitHub that lets you edit PDFs on any device anywhere.
   - Updated on `Sun 28 June 2026 at 08:48 AM` | 84949⭐ | `Other`
...
- [songquanpeng/one-api](https://github.com/songquanpeng/one-api) - LLM API 管理 & 分发系统，支持 OpenAI、Azure、Anthropic Claude、Google Gemini、DeepSeek、字节豆包、ChatGLM、文心一言、讯飞星火、通义千问、360 智脑、腾讯混元等主流模型，统一 API 适配，可用于 key 管理与二次分发。单可执行文件，提供 Docker 镜像，一键部署，开箱即用。LLM API management & key .
   - Updated on `Fri 09 January 2026 at 03:26 AM` | 35317⭐ | `MIT License`
...
- [tldr-pages/tldr](https://github.com/tldr-pages/tldr) - Collaborative cheatsheets for console commands 📚.
   - Updated on `Mon 29 June 2026 at 12:20 AM` | 62974⭐ | `Other`
...
- [sindresorhus/awesome](https://github.com/sindresorhus/awesome) - 😎 Awesome lists about all kinds of interesting topics.
   - Updated on `Thu 25 June 2026 at 12:00 PM` | 479638⭐ | `Creative Commons Zero v1.0 Universal`
...
- [pewdiepie-archdaemon/odysseus](https://github.com/pewdiepie-archdaemon/odysseus) - Self-hosted AI workspace.
   - Updated on `Sun 28 June 2026 at 05:05 PM` | 78991⭐ | `GNU Affero General Public License v3.0`
...
- [microsoft/markitdown](https://github.com/microsoft/markitdown) - Python tool for converting files and office documents to Markdown.
   - Updated on `Wed 24 June 2026 at 03:32 PM` | 160610⭐ | `MIT License`
...
- [safishamsi/graphify](https://github.com/safishamsi/graphify) - AI coding assistant skill (Claude Code, Codex, OpenCode, Cursor, Gemini CLI, and more). Turn any folder of code, SQL schemas, R scripts, shell scripts, docs, papers, images, or videos into a queryable.
   - Updated on `Sun 28 June 2026 at 09:45 PM` | 73689⭐ | `MIT License`
...
- [D4Vinci/Scrapling](https://github.com/D4Vinci/Scrapling) - 🕷️ An adaptive Web Scraping framework that handles everything from a single request to a full-scale crawl!.
   - Updated on `Fri 26 June 2026 at 08:59 AM` | 66771⭐ | `BSD 3-Clause "New" or "Revised" License`
...
- [browser-use/browser-use](https://github.com/browser-use/browser-use) - 🌐 Make websites accessible for AI agents. Automate tasks online with ease.
   - Updated on `Sun 28 June 2026 at 04:03 AM` | 101160⭐ | `MIT License`
...
- [opendatalab/MinerU](https://github.com/opendatalab/MinerU) - Transforms complex documents like PDFs and Office docs into LLM-ready markdown/JSON for your Agentic workflows.
   - Updated on `Sat 27 June 2026 at 07:38 AM` | 71571⭐ | `Other`
...
- [mem0ai/mem0](https://github.com/mem0ai/mem0) - Universal memory layer for AI Agents.
   - Updated on `Sat 27 June 2026 at 05:10 PM` | 59633⭐ | `Apache License 2.0`
...
- [openai/whisper](https://github.com/openai/whisper) - Robust Speech Recognition via Large-Scale Weak Supervision.
   - Updated on `Wed 15 April 2026 at 04:32 PM` | 103792⭐ | `MIT License`
...
- [commaai/openpilot](https://github.com/commaai/openpilot) - openpilot is an operating system for robotics. Currently, it upgrades the driver assistance system on 300+ supported cars.
   - Updated on `Mon 29 June 2026 at 12:08 AM` | 62376⭐ | `MIT License`
...
- [Significant-Gravitas/AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) - AutoGPT is the vision of accessible AI for everyone, to use and to build on. Our mission is to provide the tools, so that you can focus on what matters.
   - Updated on `Sun 28 June 2026 at 11:46 PM` | 185202⭐ | `Other`
...
- [vinta/awesome-python](https://github.com/vinta/awesome-python) - An opinionated list of Python frameworks, libraries, tools, and resources.
   - Updated on `Fri 26 June 2026 at 08:02 AM` | 305308⭐ | `Other`
...
- [ruvnet/RuView](https://github.com/ruvnet/RuView) - π RuView turns commodity WiFi signals into real-time spatial intelligence, vital sign monitoring, and presence detection — all without a single pixel of video.
   - Updated on `Sun 28 June 2026 at 06:33 PM` | 75810⭐ | `MIT License`
...
- [warpdotdev/warp](https://github.com/warpdotdev/warp) - Warp is an agentic development environment, born out of the terminal.
   - Updated on `Mon 29 June 2026 at 12:21 AM` | 62538⭐ | `GNU Affero General Public License v3.0`
- [cjpais/Handy](https://github.com/cjpais/Handy) - A free, open source, and extensible speech-to-text application that works completely offline.
   - Updated on `Mon 29 June 2026 at 12:10 AM` | 25151⭐ | `MIT License`
...
- [tw93/Pake](https://github.com/tw93/Pake) - 🤱🏻 Turn any webpage into a desktop app with one command.
   - Updated on `Sun 28 June 2026 at 01:14 AM` | 58329⭐ | `GNU General Public License v3.0`
...
- [astral-sh/ruff](https://github.com/astral-sh/ruff) - An extremely fast Python linter and code formatter, written in Rust.
   - Updated on `Mon 29 June 2026 at 12:04 AM` | 48284⭐ | `MIT License`
...
- [diegosouzapw/OmniRoute](https://github.com/diegosouzapw/OmniRoute) - Never stop coding. Free AI gateway: one endpoint, 160+ providers (50+ free), connect Claude Code, Codex, Cursor, Cline & Copilot to FREE Claude/GPT/Gemini. RTK+Caveman stacked compression saves 15-95%.
   - Updated on `Mon 29 June 2026 at 12:30 AM` | 7397⭐ | `MIT License`
...
- [papermark/papermark](https://github.com/papermark/papermark) - Papermark is the open-source DocSend alternative with built-in analytics and custom domains.
   - Updated on `Sun 28 June 2026 at 04:28 PM` | 8750⭐ | `Other`
...
- [renovatebot/renovate](https://github.com/renovatebot/renovate) - Home of the Renovate CLI: Cross-platform Dependency Automation by Mend.io.
   - Updated on `Mon 29 June 2026 at 12:29 AM` | 21884⭐ | `GNU Affero General Public License v3.0`
...
- [supabase/supabase](https://github.com/supabase/supabase) - The Postgres development platform. Supabase gives you a dedicated Postgres database to build your web, mobile, and AI applications.
   - Updated on `Sun 28 June 2026 at 10:19 AM` | 104967⭐ | `Apache License 2.0`
...
- [grafana/grafana](https://github.com/grafana/grafana) - The open and composable observability and data visualization platform. Visualize metrics, logs, and traces from multiple sources like Prometheus, Loki, Elasticsearch, InfluxDB, Postgres and many more.
   - Updated on `Mon 29 June 2026 at 12:17 AM` | 75149⭐ | `GNU Affero General Public License v3.0`
