...
- [netdata/netdata](https://github.com/netdata/netdata) - X-Ray Vision for your infrastructure!.
   - Updated on `Sat 26 April 2025 at 12:22 AM` | 74375⭐ | `GNU General Public License v3.0`
...
- [jellyfin/jellyfin](https://github.com/jellyfin/jellyfin) - The Free Software Media System - Server Backend & API.
   - Updated on `Fri 25 April 2025 at 03:30 PM` | 39036⭐ | `GNU General Public License v2.0`
...
- [microsoft/terminal](https://github.com/microsoft/terminal) - The new Windows Terminal and the original Windows console host, all in the same place!.
   - Updated on `Fri 25 April 2025 at 11:00 PM` | 97821⭐ | `MIT License`
...
- [kopia/kopia](https://github.com/kopia/kopia) - Cross-platform backup tool for Windows, macOS & Linux with fast, incremental backups, client-side end-to-end encryption, compression and data deduplication. CLI and GUI included.
   - Updated on `Fri 25 April 2025 at 09:47 PM` | 9317⭐ | `Apache License 2.0`
...
- [gchq/CyberChef](https://github.com/gchq/CyberChef) - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis.
   - Updated on `Sat 05 April 2025 at 06:13 PM` | 31015⭐ | `Apache License 2.0`
...
- [awesome-selfhosted/awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) - A list of Free Software network services and web applications which can be hosted on your own servers.
   - Updated on `Wed 23 April 2025 at 10:55 PM` | 226076⭐ | `Other`
...
- [opendatalab/MinerU](https://github.com/opendatalab/MinerU) - A high-quality tool for convert PDF to Markdown and JSON.一站式开源高质量数据提取工具，将PDF转换成Markdown和JSON格式。.
   - Updated on `Fri 25 April 2025 at 02:54 AM` | 32213⭐ | `GNU Affero General Public License v3.0`
...
- [dgtlmoon/changedetection.io](https://github.com/dgtlmoon/changedetection.io) - The best and simplest free open source web page change detection, website watcher,  restock monitor and notification service. Restock Monitor, change detection. Designed for simplicity - Simply monito.
   - Updated on `Fri 25 April 2025 at 04:45 PM` | 23751⭐ | `Apache License 2.0`
