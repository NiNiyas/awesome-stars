...
- [git/git](https://github.com/git/git) - Git Source Code Mirror - This is a publish-only repository but pull requests can be turned into patches to the mailing list via GitGitGadget (https://gitgitgadget.github.io/). Please follow Documentat.
   - Updated on `Wed 11 September 2024 at 09:17 PM` | 51738⭐ | `Other`
...
- [snake-4/Zygisk-Assistant](https://github.com/snake-4/Zygisk-Assistant) - A Zygisk module to hide root for KernelSU, Magisk and APatch, designed to work on Android 5.0 and above.
   - Updated on `Wed 04 September 2024 at 10:02 PM` | 906⭐ | `MIT License`
...
- [Stirling-Tools/Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF) - #1 Locally hosted web application that allows you to perform various operations on PDF files.
   - Updated on `Tue 10 September 2024 at 09:59 PM` | 41362⭐ | `MIT License`
...
- [iptv-org/iptv](https://github.com/iptv-org/iptv) - Collection of publicly available IPTV channels from all over the world.
   - Updated on `Thu 12 September 2024 at 12:09 AM` | 84249⭐ | `The Unlicense`
...
- [Raphire/Win11Debloat](https://github.com/Raphire/Win11Debloat) - A simple, easy to use PowerShell script to remove pre-installed apps from Windows, disable telemetry, remove Bing from Windows search as well as perform various other changes to declutter and improve .
   - Updated on `Wed 04 September 2024 at 03:46 PM` | 12278⭐ | `MIT License`
...
- [Cinnamon/kotaemon](https://github.com/Cinnamon/kotaemon) - An open-source RAG-based tool for chatting with your documents.
   - Updated on `Wed 11 September 2024 at 01:47 PM` | 11346⭐ | `Apache License 2.0`
...
- [tw93/Pake](https://github.com/tw93/Pake) - 🤱🏻 Turn any webpage into a desktop app with Rust.  🤱🏻 利用 Rust 轻松构建轻量级多端桌面应用.
   - Updated on `Wed 11 September 2024 at 12:36 PM` | 25610⭐ | `MIT License`
...
- [CorentinTh/it-tools](https://github.com/CorentinTh/it-tools) - Collection of handy online tools for developers, with great UX.
   - Updated on `Sun 25 August 2024 at 09:04 PM` | 20596⭐ | `GNU General Public License v3.0`
