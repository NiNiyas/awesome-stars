...
- [massgravel/Microsoft-Activation-Scripts](https://github.com/massgravel/Microsoft-Activation-Scripts) - Open-source Windows and Office activator featuring HWID, Ohook, TSforge, and Online KMS activation methods, along with advanced troubleshooting.
   - Updated on `Thu 07 May 2026 at 04:42 PM` | 175157⭐ | `GNU General Public License v3.0`
...
- [valkey-io/valkey](https://github.com/valkey-io/valkey) - A flexible distributed key-value database that is optimized for caching and other realtime workloads.
   - Updated on `Wed 13 May 2026 at 08:47 PM` | 25751⭐ | `Other`
...
- [ggml-org/llama.cpp](https://github.com/ggml-org/llama.cpp) - LLM inference in C/C++.
   - Updated on `Wed 13 May 2026 at 11:23 PM` | 109961⭐ | `MIT License`
...
- [decolua/9router](https://github.com/decolua/9router) - Unlimited FREE AI coding. Connect Claude Code, Codex, Cursor, Cline, Copilot, Antigravity to FREE Claude/GPT/Gemini via 40+ providers. Auto-fallback, RTK -40% tokens, never hit limits.
   - Updated on `Wed 13 May 2026 at 05:28 PM` | 9861⭐ | `MIT License`
...
- [songquanpeng/one-api](https://github.com/songquanpeng/one-api) - LLM API 管理 & 分发系统，支持 OpenAI、Azure、Anthropic Claude、Google Gemini、DeepSeek、字节豆包、ChatGLM、文心一言、讯飞星火、通义千问、360 智脑、腾讯混元等主流模型，统一 API 适配，可用于 key 管理与二次分发。单可执行文件，提供 Docker 镜像，一键部署，开箱即用。LLM API management & key .
   - Updated on `Fri 09 January 2026 at 03:26 AM` | 33650⭐ | `MIT License`
...
- [nodejs/node](https://github.com/nodejs/node) - Node.js JavaScript runtime ✨🐢🚀✨.
   - Updated on `Wed 13 May 2026 at 10:23 PM` | 117186⭐ | `Other`
...
- [farag2/Sophia-Script-for-Windows](https://github.com/farag2/Sophia-Script-for-Windows) - :zap: The most powerful open source tweaker on GitHub for fine-tuning Windows 10 & Windows 11.
   - Updated on `Wed 13 May 2026 at 09:01 AM` | 9278⭐ | `MIT License`
...
- [CloakHQ/CloakBrowser](https://github.com/CloakHQ/CloakBrowser) - Stealth Chromium that passes every bot detection test. Drop-in Playwright replacement with source-level fingerprint patches. 30/30 tests passed.
   - Updated on `Wed 13 May 2026 at 04:55 PM` | 9493⭐ | `MIT License`
...
- [D4Vinci/Scrapling](https://github.com/D4Vinci/Scrapling) - 🕷️ An adaptive Web Scraping framework that handles everything from a single request to a full-scale crawl!.
   - Updated on `Mon 11 May 2026 at 12:41 PM` | 49318⭐ | `BSD 3-Clause "New" or "Revised" License`
...
- [PostHog/posthog](https://github.com/PostHog/posthog) - 🦔 PostHog is an all-in-one developer platform for building successful products. We offer product analytics, web analytics, session replay, error tracking, feature flags, experimentation, surveys, data.
   - Updated on `Thu 14 May 2026 at 12:27 AM` | 34458⭐ | `Other`
...
- [BerriAI/litellm](https://github.com/BerriAI/litellm) - Python SDK, Proxy Server (AI Gateway) to call 100+ LLM APIs in OpenAI (or native) format, with cost tracking, guardrails, loadbalancing and logging. [Bedrock, Azure, OpenAI, VertexAI, Cohere, Anthropi.
   - Updated on `Thu 14 May 2026 at 12:26 AM` | 46853⭐ | `Other`
...
- [Significant-Gravitas/AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) - AutoGPT is the vision of accessible AI for everyone, to use and to build on. Our mission is to provide the tools, so that you can focus on what matters.
   - Updated on `Thu 14 May 2026 at 12:21 AM` | 184291⭐ | `Other`
...
- [pallets/flask](https://github.com/pallets/flask) - The Python micro framework for building web applications.
   - Updated on `Wed 13 May 2026 at 02:37 PM` | 71526⭐ | `BSD 3-Clause "New" or "Revised" License`
...
- [tinyhumansai/openhuman](https://github.com/tinyhumansai/openhuman) - Your Personal AI super intelligence. Private, Simple and extremely powerful.
   - Updated on `Wed 13 May 2026 at 09:32 PM` | 5455⭐ | `GNU General Public License v3.0`
...
- [rustdesk/rustdesk](https://github.com/rustdesk/rustdesk) - An open-source remote desktop application designed for self-hosting, as an alternative to TeamViewer.
   - Updated on `Wed 13 May 2026 at 10:43 AM` | 114101⭐ | `GNU Affero General Public License v3.0`
...
- [millionco/react-doctor](https://github.com/millionco/react-doctor) - Your agent writes bad React. This catches it.
   - Updated on `Wed 13 May 2026 at 07:37 PM` | 9267⭐ | `MIT License`
...
- [anomalyco/opencode](https://github.com/anomalyco/opencode) - The open source coding agent.
   - Updated on `Thu 14 May 2026 at 12:26 AM` | 159781⭐ | `MIT License`
...
- [4gray/iptvnator](https://github.com/4gray/iptvnator) - :tv: Cross-platform IPTV player application with multiple features, such as support of m3u and m3u8 playlists, favorites, TV guide, TV archive/catchup and more.
   - Updated on `Wed 13 May 2026 at 10:13 PM` | 6016⭐ | `MIT License`
...
- [firecrawl/firecrawl](https://github.com/firecrawl/firecrawl) - 🔥 The API to search, scrape, and interact with the web for AI.
   - Updated on `Wed 13 May 2026 at 10:27 PM` | 119462⭐ | `GNU Affero General Public License v3.0`
...
- [apache/superset](https://github.com/apache/superset) - Apache Superset is a Data Visualization and Data Exploration Platform.
   - Updated on `Thu 14 May 2026 at 12:16 AM` | 72812⭐ | `Apache License 2.0`
...
- [supabase/supabase](https://github.com/supabase/supabase) - The Postgres development platform. Supabase gives you a dedicated Postgres database to build your web, mobile, and AI applications.
   - Updated on `Wed 13 May 2026 at 10:40 PM` | 102291⭐ | `Apache License 2.0`
...
- [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) - A one-of-a-kind resume builder that keeps your privacy in mind. Completely secure, customizable, portable, open-source and free forever. Try it out today!.
   - Updated on `Thu 14 May 2026 at 12:28 AM` | 36783⭐ | `MIT License`
...
- [oven-sh/bun](https://github.com/oven-sh/bun) - Incredibly fast JavaScript runtime, bundler, test runner, and package manager – all in one.
   - Updated on `Thu 14 May 2026 at 12:27 AM` | 89993⭐ | `Other`
