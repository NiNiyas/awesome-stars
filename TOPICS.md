...
- [Pythagora-io/gpt-pilot](https://github.com/Pythagora-io/gpt-pilot) - Dev tool that writes scalable apps from scratch while the developer oversees the implementation.
   - Updated on `Mon 08 January 2024 at 03:48 PM` | 19704⭐ | `MIT License`
...
- [JoeanAmier/TikTokDownloader](https://github.com/JoeanAmier/TikTokDownloader) - 完全免费开源，基于 Requests 模块实现：TikTok 主页/视频/图集/原声；抖音主页/视频/图集/收藏/直播/原声/合集/评论/账号/搜索/热榜数据采集工具.
   - Updated on `Sun 07 January 2024 at 10:39 AM` | 3583⭐ | `GNU General Public License v3.0`
- [StanGirard/quivr](https://github.com/StanGirard/quivr) - Your GenAI Second Brain 🧠  A personal productivity assistant (RAG) ⚡️🤖 Chat with your docs (PDF, CSV, ...)  & apps using Langchain, GPT 3.5 / 4 turbo, Private, Anthropic, VertexAI, Ollama, LLMs, that .
   - Updated on `Mon 08 January 2024 at 11:29 PM` | 26864⭐ | `Apache License 2.0`
...
- [awesome-selfhosted/awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) - A list of Free Software network services and web applications which can be hosted on your own servers.
   - Updated on `Sun 07 January 2024 at 03:01 PM` | 163982⭐ | `Other`
...
- [Stirling-Tools/Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF) - locally hosted web application that allows you to perform various operations on PDF files.
   - Updated on `Mon 08 January 2024 at 08:31 AM` | 15188⭐ | `GNU General Public License v3.0`
- [opennaslab/kubespider](https://github.com/opennaslab/kubespider) - A global resource download orchestration system, build your home download center.
   - Updated on `Tue 02 January 2024 at 01:58 AM` | 1709⭐ | `Apache License 2.0`
...
- [abi/screenshot-to-code](https://github.com/abi/screenshot-to-code) - Drop in a screenshot and convert it to clean code (HTML/Tailwind/React/Vue).
   - Updated on `Mon 08 January 2024 at 09:55 PM` | 33273⭐ | `MIT License`
