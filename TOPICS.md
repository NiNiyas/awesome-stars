...
- [Significant-Gravitas/Auto-GPT](https://github.com/Significant-Gravitas/Auto-GPT) - An experimental open-source attempt to make GPT-4 fully autonomous.
   - Updated on `Fri 16 June 2023 at 12:44 AM` | 139779⭐ | `MIT License`
...
- [localsend/localsend](https://github.com/localsend/localsend) - An open source cross-platform alternative to AirDrop.
   - Updated on `Thu 15 June 2023 at 08:46 AM` | 11467⭐ | `MIT License`
- [NamanShergill/diohub](https://github.com/NamanShergill/diohub) - An open-source unofficial GitHub mobile client, that aims to deliver the ultimate GitHub experience on mobile devices.
   - Updated on `Sun 21 May 2023 at 08:15 AM` | 444⭐ | `GNU General Public License v3.0`
- [TomBursch/kitchenowl](https://github.com/TomBursch/kitchenowl) - KitchenOwl is a self-hosted grocery list and recipe manager. The backend is made with Flask and the frontend with Flutter. Easily add items to your shopping list before you go shopping. You can also c.
   - Updated on `Thu 15 June 2023 at 09:03 AM` | 395⭐ | `GNU Affero General Public License v3.0`
...
- [SigNoz/signoz](https://github.com/SigNoz/signoz) - SigNoz is an open-source APM. It helps developers monitor their applications & troubleshoot problems, an open-source alternative to DataDog, NewRelic, etc. 🔥 🖥.   👉  Open source Application Performanc.
   - Updated on `Thu 15 June 2023 at 09:32 PM` | 13147⭐ | `Other`
- [harness/drone](https://github.com/harness/drone) - Drone is a Container-Native, Continuous Delivery Platform.
   - Updated on `Sun 14 May 2023 at 07:23 AM` | 26961⭐ | `Other`
